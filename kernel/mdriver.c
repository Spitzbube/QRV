...
static void kerext_md_detach(void *d)
{
...
static void md_detach(union sigval d)
{
...
static const struct sigevent *md_intr(void *d, int id)
{
    struct mdriver_entry *md = d;
    int r;
...
static void kerext_md_attach(void *d)
{
    struct mdriver_entry *md = d;
    int level;
    int id;
