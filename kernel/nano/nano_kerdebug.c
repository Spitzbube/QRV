...
unsigned
kdebug_vtop(struct kdebug_entry *entry, uintptr_t vaddr, paddr64_t * paddrp, paddr64_t * sizep)
{
    PROCESS *prp;
    paddr_t paddr;
    size_t size;
...
int kd_request(union kd_request *r)
{
    unsigned i;
...
static struct kdebug_info *register_info(void)
{
...
static void do_kdebug_detach(void *data)
{
...
int kdebug_watch_entry(struct kdebug_entry *entry, uintptr_t ip)
{
    struct kdebug_callback *call;
...
void kdebug_kdump_private(const struct kdump_private *kdump)
{
