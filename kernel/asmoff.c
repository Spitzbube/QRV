...
VALUE(QRV_FLG_THR_SIG_ACTIVE, QRV_FLG_THR_SIG_ACTIVE);
VALUE(QRV_FLG_THR_SIGWAITINFO, QRV_FLG_THR_SIGWAITINFO);
VALUE(QRV_FLG_THR_NANOSLEEP, QRV_FLG_THR_NANOSLEEP);
VALUE(QRV_FLG_THR_SIGSUSPEND, QRV_FLG_THR_SIGSUSPEND);
VALUE(QRV_FLG_THR_RCVINFO, QRV_FLG_THR_RCVINFO);
VALUE(QRV_FLG_THR_WAAA, QRV_FLG_THR_WAAA);
VALUE(QRV_FLG_THR_TO_BE_STOPPED, QRV_FLG_THR_TO_BE_STOPPED);
VALUE(QRV_FLG_THR_JOIN, QRV_FLG_THR_JOIN);
VALUE(QRV_FLG_THR_ACQUIRE_MUTEX, QRV_FLG_THR_ACQUIRE_MUTEX);
VALUE(QRV_FLG_THR_V86, QRV_FLG_THR_V86);
VALUE(QRV_FLG_THR_SPECRET_MASK, QRV_FLG_THR_SPECRET_MASK);
VALUE(QRV_FLG_THR_KCALL_ACTIVE, QRV_FLG_THR_KCALL_ACTIVE);
VALUE(QRV_FLG_THR_KERERR_SET, QRV_FLG_THR_KERERR_SET);
VALUE(QRV_FLG_THR_ALIGN_FAULT, QRV_FLG_THR_ALIGN_FAULT);
VALUE(QRV_FLG_THR_BUFF_MSG, QRV_FLG_THR_BUFF_MSG);
VALUE(QRV_FLG_THR_SHORT_MSG, QRV_FLG_THR_SHORT_MSG);
VALUE(QRV_FLG_THR_PULSE, QRV_FLG_THR_PULSE);
VALUE(QRV_FLG_THR_IOPRIV, QRV_FLG_THR_IOPRIV);
