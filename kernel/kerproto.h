...
void rdecl synchash_rem(unsigned addr, OBJECT * obp, unsigned addr1, unsigned addr2, PROCESS * prp,
                        void *vaddr);
...
int rdecl msgreceive_gbl(THREAD * act, CHANNELGBL * chp, void *msg, size_t size,
