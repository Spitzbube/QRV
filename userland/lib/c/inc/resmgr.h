...
extern int _resmgr_io_handler(resmgr_context_t * ctp, resmgr_iomsgs_t * msg,
...
extern int _resmgr_access(resmgr_context_t * ctp, struct _msg_info *msginfo, int ioflag,
                          unsigned key1, void *msg, int size);
extern int _resmgr_link_handler(resmgr_context_t * ctp, resmgr_iomsgs_t * msg, struct link *link,
                                struct _msg_info *info, int (*func)(resmgr_context_t * ctp,
                                                                    resmgr_iomsgs_t * msg,
                                                                    void *handle, void *ocb));
extern void _resmgr_close_handler(resmgr_context_t * ctp, struct binding *binding);

int _resmgr_mount_handler(resmgr_context_t * ctp, resmgr_iomsgs_t * msg, struct link *link,
                          io_mount_extra_t * extra, int (*func)(resmgr_context_t * ctp,
                                                                resmgr_iomsgs_t * msg, void *handle,
                                                                void *extra));
