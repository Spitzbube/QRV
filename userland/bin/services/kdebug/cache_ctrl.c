...
static void cache_one(struct cacheattr_entry *cache, uintptr_t base, size_t len, int flags)
{
    uintptr_t vaddr;
    size_t cache_len;
...
static void cache_iterate(int cache_idx, uintptr_t base, size_t len, int flags, unsigned term_flag)
{
