...
_C_LIB_DECL typedef const short *_Ctype_t;
...
_END_C_LIB_DECL
    ...
    // INLINES, for C++
_C_LIB_DECL inline int isalnum(int _Ch)
{                               // check alnum bits
...
inline int _tolower(int _Ch)
{                               /* convert to lower case */
    return (_CSTD _Tolotab[_Ch]);
}

inline int _toupper(int _Ch)
{                               /* convert to upper case */
...
inline int __isascii(int _Ch)
{                               /* check ascii */
    return ((unsigned) (_Ch) <= 0x7f);
}

inline int __toascii(int _Ch)
{                               /* convert to ascii */
    return ((int) (_Ch) & 0x7f);
}

inline int __iscsymf(int _Ch)
{                               /* check first C symbol */
    return (_CSTD isalpha(_Ch) || (_Ch) == '_');
}

inline int __iscsym(int _Ch)
{                               /* check next C symbol */
