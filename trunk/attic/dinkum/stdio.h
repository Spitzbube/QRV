...
__BEGIN_DECLS extern _CSTD FILE *_Files[FOPEN_MAX];
...
_C_STD_BEGIN extern FILE _Stdin, _Stdout, _Stderr;
_C_STD_END
...
#endif
_C_STD_BEGIN extern void clearerr(FILE * __fp);
...
extern int vsnprintf(char *__s, size_t __size, const char *__format, __NTO_va_list __arg)
    __attribute__((format(printf, 3, 0)));
extern FILE *fdopen(int __handle, const char *__mode);
extern int fileno(_CSTD FILE * __fp);
_C_STD_END extern int fseeko(_CSTD FILE * __fp, off_t __offset, int __whence) __ALIAS64("fseeko64");
...
#endif
extern int snprintf(char *__s, _CSTD size_t __size, const char *__format, ...)
...
extern int vfscanf(_CSTD FILE * __fp, const char *__format, __NTO_va_list __arg)
    __attribute__((format(scanf, 2, 0)));
extern int vscanf(const char *__format, __NTO_va_list __arg) __attribute__((format(scanf, 1, 0)));
extern int vsscanf(const char *__s, const char *__format, __NTO_va_list __arg)
    __attribute__((format(scanf, 2, 0)));
#endif
...
{                               /* get a character */
    return ((_Str->_Next < _Str->_Rend ? *_Str->_Next++ : _CSTD fgetc(_Str)));
}

inline int getchar_unlocked()
{                               /* get a character from stdin */
    return ((_Files[0]->_Next < _Files[0]->_Rend ? *_Files[0]->_Next++ : _CSTD fgetc(_Files[0])));
}
...
__BEGIN_DECLS _C_STD_BEGIN extern int getc(FILE * __fp);
...
#endif
#if defined(__EXT_POSIX1_199506)
__BEGIN_DECLS extern void flockfile(_CSTD FILE * __fp);
