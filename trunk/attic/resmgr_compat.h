...
extern int _resmgr_pathname_attach(const char *path, int chid, enum _file_type file_type,
...
extern int resmgr_open_bind(resmgr_context_t * ctp, RESMGR_OCB_T * ocb,
...
extern int _resmgr_pulse_attach(int code,
                                void (*func)(resmgr_context_t * ctp, int code, union sigval value,
...
extern int resmgr_msgwritev(resmgr_context_t * ctp, const struct iovec *smsg, int sparts,
                            int offset);
