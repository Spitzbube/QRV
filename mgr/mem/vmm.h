...
int map_create(struct map_set *, struct map_set *,
               struct mm_map_head *, uintptr_t va, uintptr_t size, uintptr_t mask, unsigned flags);
...
int map_isolate(struct map_set *, struct mm_map_head *, uintptr_t start, size_t size, int flags);
...
extern int pte_temp_map(ADDRESS *, uintptr_t, struct pa_quantum *, struct mm_map *, size_t,
                        int (*func)(void *, size_t, void *), void *);
...
extern int memobj_pmem_walk(int, OBJECT *, off64_t, off64_t,
                            int (*func)(OBJECT *, off64_t, struct pa_quantum *, unsigned, void *),
                            void *);
extern int memobj_pmem_walk_mm(int, struct mm_map *,
                               int (*func)(OBJECT *, off64_t, struct pa_quantum *, unsigned,
                                           void *), void *);
