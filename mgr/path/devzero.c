...
static int zero_write(resmgr_context_t * ctp, io_write_t * msg, void *ocb)
{
...
static int zero_read(resmgr_context_t * ctp, io_read_t * msg, void *ocb)
{
    unsigned ioflag = (uintptr_t) ocb;
    int nbytes;
    int size;
...
static int zero_stat(resmgr_context_t * ctp, io_stat_t * msg, void *ocb)
{
...
static int zero_devctl(resmgr_context_t * ctp, io_devctl_t * msg, void *ocb)
{
    union {
        int oflag;
        int mountflag;
...
static int zero_open(resmgr_context_t * ctp, io_open_t * msg, void *extra, void *reserved)
{
...
int devzero_check(const resmgr_io_funcs_t * funcs, mem_map_t * msg, void *handle, OBJECT ** pobp)
{
