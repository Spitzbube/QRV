...
int procmgr_msg_resource(resmgr_context_t * ctp, void *vmsg)
{
    ...
    case _PROC_RESOURCE_USAGE:
        ...
        case RUSAGE_CHILDREN:{
                ...
                if (DebugProcess
                    (NTO_DEBUG_PROCESS_INFO, prp->pid, 0, (union nto_debug_data *) &info) == -1) {
    ...
    case _PROC_RESOURCE_SETLIMIT:
        ...
        case RLIMIT_CORE:
            break;
        case RLIMIT_VMEM:
            break;              // VMEM is the same as RLIMIT_AS
        case RLIMIT_STACK:
            break;
        case RLIMIT_DATA:
            break;
        ...
        ret = set_rlimit_resource(cur, max,
                                  ...
                                  &prp->rlimit_vals_hard[msg->setlimit.i.entry[0].resource], ctp);
        if (ret != 0) {
    ...
    case _PROC_RESOURCE_GETLIMIT:
        ...
        case RLIMIT_CPU:{
                ...
                if (prp->rlimit_vals_soft[msg->getlimit.i.resource[0]] == RLIM_INFINITY) {
                    ...
                    msg->getlimit.o[0].rlim_cur =
                        prp->rlimit_vals_soft[msg->getlimit.i.resource[0]];
                }
                if (prp->rlimit_vals_hard[msg->getlimit.i.resource[0]] == RLIM_INFINITY) {
                    msg->getlimit.o[0].rlim_max = RLIM64_INFINITY;
                } else {
                    msg->getlimit.o[0].rlim_max =
                        prp->rlimit_vals_hard[msg->getlimit.i.resource[0]];
                }
                break;
            }
