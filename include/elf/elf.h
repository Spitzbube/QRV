...
#if !defined(ELF_TARGET_ALL) && !defined(ELF_TARGET_X86) && !defined(ELF_TARGET_PPC) && !defined(ELF_TARGET_MIPS) && !defined(ELF_TARGET_68K) && !defined(ELF_TARGET_ARM) && !defined(ELF_TARGET_RISCV)
#if defined(__X86__)
