...
extern int timer_settime(timer_t __timerid, int __flags, const struct itimerspec *__value,
                         struct itimerspec *__ovalue);
#endif

#if defined(__EXT_QNX)
extern int nanosleep_abs(clockid_t __clock_id, const struct timespec *__rqtp);
extern int nanosleep_rel(clockid_t __clock_id, const struct timespec *__rqtp,
                         struct timespec *__rmtp);
#endif
#if defined(__EXT_POSIX1_200112)    /* Approved 1003.1j D10 */
extern int clock_nanosleep(clockid_t __clock_id, int __flags, const struct timespec *__rqtp,
                           struct timespec *__rmtp);
#endif
#if defined(__EXT_QNX)
