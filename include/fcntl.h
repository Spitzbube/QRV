...
static __inline int
    __attribute__((__unused__)) posix_fallocate(int __fd, off_t __offset, off_t __len)
{
...
extern int _connect_entry(int __base, const char *__path, mode_t __mode, unsigned __oflag,
                          unsigned __sflag, unsigned __subtype, int __testcancel, unsigned __access,
                          unsigned __file_type, unsigned __extra_type, unsigned __extra_len,
                          const void *__extra, unsigned __response_len, void *__response,
                          int *__status, struct _io_connect_entry *__entry, int __enoretry);

extern int _connect_fd(int __base, const char *__path, mode_t __mode, unsigned __oflag,
                       unsigned __sflag, unsigned __subtype, int __testcancel, unsigned __access,
                       unsigned __file_type, unsigned __extra_type, unsigned __extra_len,
                       const void *__extra, unsigned __response_len, void *__response,
                       int *__status, int *fd_len, void *fd_array);

extern int _connect(int __base, const char *__path, mode_t __mode, unsigned __oflag,
                    unsigned __sflag, unsigned __subtype, int __testcancel, unsigned __access,
                    unsigned __file_type, unsigned __extra_type, unsigned __extra_len,
                    const void *__extra, unsigned __response_len, void *__response, int *__status);

extern int _connect_combine(const char *__path, mode_t __mode, unsigned __oflag, unsigned __sflag,
                            int __testcancel, unsigned __file_type, unsigned __extra_len,
                            void *__extra, unsigned __response_len, void *__response);

extern int _connect_object(const char *__name, const char *__prefix, mode_t __mode, int __oflag,
                           unsigned __file_type, unsigned __extra_type, unsigned __extra_len,
                           const void *__extra);
