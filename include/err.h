...
extern void verr __P((int, const char *, va_list))
    __attribute__((__noreturn__, __format__(__printf__, 2, 0)));
extern void errx __P((int, const char *, ...))
    __attribute__((__noreturn__, __format__(__printf__, 2, 3)));
extern void verrx __P((int, const char *, va_list))
    __attribute__((__noreturn__, __format__(__printf__, 2, 0)));
extern void warn __P((const char *, ...))
    __attribute__((__format__(__printf__, 1, 2)));
extern void vwarn __P((const char *, va_list))
    __attribute__((__format__(__printf__, 1, 0)));
extern void warnx __P((const char *, ...))
    __attribute__((__format__(__printf__, 1, 2)));
extern void vwarnx __P((const char *, va_list))
    __attribute__((__format__(__printf__, 1, 0)));
__END_DECLS
#endif
