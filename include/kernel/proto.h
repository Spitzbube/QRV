...
int rdecl thread_create(THREAD * act, PROCESS * prp, const struct sigevent *evp,
...
PULSE *rdecl pulse_replace(PROCESS * prp, PRIL_HEAD * queue, int priority, int code, int value,
                           int id);
int rdecl pulse_deliver(CHANNEL * chp, int priority, int code, int value, int id,
...
int rdecl signal_kill_thread(PROCESS * prp, THREAD * thp, int signo, int code, int value, pid_t pid,
                             unsigned signal_flags);
int rdecl signal_kill_process(PROCESS * prp, int signo, int code, int value, pid_t pid,
                              unsigned signal_flags);
int rdecl signal_kill_group(THREAD * killer, pid_t pgrp, int signo, int code, int value, pid_t pid,
                            unsigned signal_flags);
