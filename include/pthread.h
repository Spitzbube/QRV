...
extern int pthread_attr_getstack(const pthread_attr_t * __attr, void **__stackaddr,
                                 size_t *__stacksize);
...
#if defined(__EXT_QNX)
extern void __cleanup_push(struct __cleanup_handler *__cleanup, void (*__func)(void *__arg),
                           void *__arg);
...
extern int pthread_mutex_setprioceiling(pthread_mutex_t * __mutex, int __prioceiling,
                                        int *__old_ceiling);
...
extern int pthread_barrier_init(pthread_barrier_t * __b, const pthread_barrierattr_t * __attr,
                                unsigned int __count);
