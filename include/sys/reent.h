    ...
    struct __sFILE {
        ...
        void *_cookie;          /* cookie passed to io functions */
         ...
         _READ_WRITE_RETURN_TYPE(*_write) (struct _reent *, void *,
                                           const char *, _READ_WRITE_BUFSIZE_TYPE);
         fpos_t(*_seek) (struct _reent *, void *, fpos_t, int);
...
#include <sys/custom_file.h>
    ...
    struct __sFILE64 {
        ...
        off64_t _offset;        /* current lseek offset */
         fpos64_t(*_seek64) (struct _reent *, void *, _fpos64_t, int);
