...
extern int asyncmsg_channel_create(unsigned flags, mode_t mode, size_t buffer_size,
...
extern int asyncmsg_connect_attach(uint32_t nd, pid_t pid, int chid, unsigned index, unsigned flags,
...
extern int asyncmsg_connect_attr(int coid, struct _asyncmsg_connection_attr *old_attr,
                                 const struct _asyncmsg_connection_attr *new_attr);

extern int asyncmsg_put(int coid, const void *buff, size_t size, unsigned handle,
                        int (*call_back)(int err, void *buf, unsigned handle));

extern int asyncmsg_putv(int coid, const iov_t * iov, int parts, unsigned handle,
                         int (*call_back)(int err, void *buf, unsigned handle));
