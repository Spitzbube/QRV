...
/**
 * \brief Obtain information about a terminal device.
 *
 * \param A pointer to a struct _ttyinfo is passed in and filled by the terminal device.
 *
 * \note This call returns the name of the device associated with its file descriptor
