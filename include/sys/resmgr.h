...
typedef struct _resmgr_connect_funcs {
    ...
    int (*unlink)(resmgr_context_t * ctp, io_unlink_t * msg, RESMGR_HANDLE_T * handle,
                  void *reserved);
    int (*rename)(resmgr_context_t * ctp, io_rename_t * msg, RESMGR_HANDLE_T * handle,
                  io_rename_extra_t * extra);
    int (*mknod)(resmgr_context_t * ctp, io_mknod_t * msg, RESMGR_HANDLE_T * handle,
                 void *reserved);
    int (*readlink)(resmgr_context_t * ctp, io_readlink_t * msg, RESMGR_HANDLE_T * handle,
                    void *reserved);
    int (*link)(resmgr_context_t * ctp, io_link_t * msg, RESMGR_HANDLE_T * handle,
                io_link_extra_t * extra);
    int (*unblock)(resmgr_context_t * ctp, io_pulse_t * msg, RESMGR_HANDLE_T * handle,
                   void *reserved);
    int (*mount)(resmgr_context_t * ctp, io_mount_t * msg, RESMGR_HANDLE_T * handle,
...
extern int resmgr_open_bind(resmgr_context_t * __ctp, RESMGR_OCB_T * __ocb,
                            const resmgr_io_funcs_t * __io_funcs);
...
extern int resmgr_msgwritev(resmgr_context_t * __ctp, const struct iovec *__smsg, int __sparts,
                            int __offset);
extern int resmgr_msgread(resmgr_context_t * __ctp, void *__msg, int __size, int __offset);
extern int resmgr_msgreadv(resmgr_context_t * __ctp, struct iovec *__rmsg, int __rparts,
                           int __offset);
...
extern int resmgr_handle_tune(int __min_handles, int __min_clients, int __max_client_handles,
                              int *__min_handles_old, int *__min_clients_old,
                              int *__max_client_handles_old);
extern int resmgr_unbind(resmgr_context_t * __ctp);
extern void *_resmgr_handle(struct _msg_info *__rep, void *__handle,
                            enum _resmgr_handle_type __type);
