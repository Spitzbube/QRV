...
_C_LIB_DECL const wchar_t *wmemchr(const wchar_t *, wchar_t, size_t);
...
_END_C_LIB_DECL inline wchar_t *wmemchr(wchar_t *_S, wchar_t _C, size_t _N)
...
_C_LIB_DECL wchar_t *wmemchr(const wchar_t *, wchar_t, size_t);
