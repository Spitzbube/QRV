...
extern void pmd_attr_setmodes(pmd_attr_t * __pmd, pm_power_mode_t __mode,
                              const pmd_mode_attr_t * __modes, int __nmodes);
extern int pmd_attach(const char *__name, pmd_attr_t * __pmd, const struct sigevent *__event,
                      mode_t __mode);
 ...
 */
extern int _pm_connect(const char *__name, int __flags, mode_t __mode, void *__extra,
                       int __extra_len, void *__response, int __response_len);
extern char *_pm_pathname(const char *__name);
extern const pmd_mode_attr_t *pmd_validate_mode(pmd_attr_t * pmd, pm_power_mode_t mode,
                                                unsigned *flags);
